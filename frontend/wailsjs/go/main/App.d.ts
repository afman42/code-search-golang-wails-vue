...
export function GetAllSymbols(arg1:string,arg2:number):Promise<Array<models.SymbolInfo>>;
...
export function SearchSymbols(arg1:string,arg2:string,arg3:number):Promise<Array<models.SymbolInfo>>;
